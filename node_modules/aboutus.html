...
<head>
    <title>Ristorant Con Fusion: About Us</title>
    <!-- CSS only -->
    ...
    <link rel="stylesheet" href="front-end assign/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" href="front-end assign/bootstrap-social/bootstrap-social.css" />
</head>
...
<body>
    ...
    <header class="jumbotron">
        <div class="container">
            <div class="row row-header align-self-center">
    ...
    <footer class="footer headfooter">
        <div class="container">
            <div class="row">
